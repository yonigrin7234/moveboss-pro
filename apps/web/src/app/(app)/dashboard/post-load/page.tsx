  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload: Record<string, unknown> = {
        ...
        // job_number not set - load_number auto-generated by DB trigger
        ...
        cubic_feet_estimate: parseFloat(data.cubic_feet) || 0,
        weight_lbs_estimate: null,
      ...
      if (loadType === 'live_load') {
        ...
        // Use pickup_* columns (these definitely exist)
        ...
        // RFD has storage location as origin
        // Use pickup_* columns (these definitely exist)
