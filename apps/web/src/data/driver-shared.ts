...
// New driver schema with pay_mode/rate cross-field validation
export const newDriverInputSchema = driverFieldsSchema
  .refine(
    (data) => {
...
// Update schema: partial fields WITHOUT cross-field pay_mode validation
// (existing driver already has valid pay_mode/rate combination in DB)
export const updateDriverInputSchema = driverFieldsSchema.partial();
