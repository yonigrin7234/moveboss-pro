  ...
  return (
    <div className="space-y-3">
      ...
      {collections.length === 0 ? (
        <div className="p-8 rounded-lg bg-white border border-border/20 text-center">
        ...
        <div className="space-y-2">
          {collections.map((item) => (
            <Link
              ...
              className="flex items-center justify-between gap-4 p-3 rounded-lg bg-white border border-border/20 hover:border-border/40 hover:shadow-sm transition-all duration-150 group"
            >
