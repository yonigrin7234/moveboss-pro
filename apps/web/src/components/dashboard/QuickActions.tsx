...
function PrimaryActionButton({ label, href, icon: Icon }: QuickAction) {
  return (
    <Link href={href} className="group block">
      <div className="relative overflow-hidden p-4 rounded-xl bg-gradient-to-br from-primary to-primary/80 shadow-md hover:shadow-lg transition-all duration-200 hover:-translate-y-0.5">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-white/80">Start a new load</p>
          </div>
