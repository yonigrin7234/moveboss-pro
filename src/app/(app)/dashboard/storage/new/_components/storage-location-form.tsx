    ...
    <form action={action}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader className="pb-4">
              <CardTitle className="text-base">{isPublicStorage ? 'Your Contact' : 'Contact at Location'}</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
          ...
          <Card>
            <CardHeader className="pb-4">
              <CardTitle className="text-base">Truck Accessibility</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
          ...
          <Card>
            <CardHeader className="pb-4">
              <CardTitle className="text-base">Rental & Payment Tracking</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
