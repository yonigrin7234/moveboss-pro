...
ALTER TABLE companies ADD COLUMN IF NOT EXISTS fmcsa_status_code TEXT;
-- 'A' = Active, 'I' = Inactive
...
ALTER TABLE companies ADD COLUMN IF NOT EXISTS fmcsa_bipd_insurance_on_file INTEGER;
-- Liability insurance in thousands
ALTER TABLE companies ADD COLUMN IF NOT EXISTS fmcsa_bipd_required_amount INTEGER;
-- Minimum required in thousands
ALTER TABLE companies ADD COLUMN IF NOT EXISTS fmcsa_cargo_insurance_on_file INTEGER;
-- Cargo insurance in thousands
...
ALTER TABLE companies ADD COLUMN IF NOT EXISTS fmcsa_operation_type TEXT;
-- e.g., 'Interstate', 'Intrastate Non-Hazmat'
